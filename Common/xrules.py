...
def execute_initial_placement(board, initial_placement):
    ...
    try:
        ...
        board.add_player(color, x, y, connected_port)
        return True
...
def execute_inter_placement(board, inter_placement):
    ...
    try:
        ...
        end_position = board.get_path(player_current_position[0], player_current_position[1], player_current_position[2])
...
if __name__ == "__main__":
    ...
    chosen_tile = tile.Tile(convert_representation(get_representation(chosen_tile_index))).rotate_tile(rotation)
    choice_one_tile = tile.Tile(convert_representation(get_representation(choice_one)))
    choice_two_tile = tile.Tile(convert_representation(get_representation(choice_two)))
